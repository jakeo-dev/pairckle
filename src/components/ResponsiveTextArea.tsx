...
export default function ResponsiveTextArea({
  ...
  return (
    <textarea
      ...
      className={`resize-none overflow-auto rounded-lg border-2 border-neutral-400/40 bg-transparent px-3.5 py-2 text-sm outline-hidden transition hover:bg-neutral-400/10 focus:bg-neutral-400/10 focus:ring-2 focus:ring-blue-300/75 active:bg-neutral-400/20 md:text-base ${className}`}
      ref={textAreaRef}
      rows={1}
