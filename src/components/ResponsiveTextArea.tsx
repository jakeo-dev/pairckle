...
export default function ResponsiveTextArea({
  ...
  return (
    <textarea
      ...
      className={`bg-neutral-400/10 hover:bg-neutral-400/20 border-neutral-400/30 border-2 rounded-md text-left transition px-3 py-2 overflow-auto resize-none pb-3 ${className}`}
      ref={textAreaRef}
      rows={1}
